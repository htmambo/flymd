...
const dict = {
  zh: {
    ...
    'theme.codeWrap': '代码块自动换行',
    'theme.codeWrap.tip': '开启后，阅读/所见模式下的代码块自动换行，不再出现横向滚动条',
    ...
    'theme.wysiwygHtmlTableSrcEdit': 'HTML源码编辑',
    'theme.wysiwygHtmlTableSrcEdit.tip': '关闭后，所见模式不再提供 HTML 源码编辑入口（表格 hover 铅笔按钮、双击 HTML 块）；编辑结果直接写回原文档',
    ...
    'filewatch.reloadFailed': '外部变更后重新加载失败,请手动重打开',
    'filewatch.conflict.title': '文件已在外部修改',
    'filewatch.conflict.body': '{name} 已被其它程序修改,且当前文档存在未保存改动。请选择处理方式:',
    'filewatch.conflict.btn.reload': '重新加载(放弃本地)',
    'filewatch.conflict.btn.keep': '保留本地(下次保存覆盖)',
    'filewatch.conflict.btn.cancel': '取消',
    'filewatch.conflict.btn.diff': '文本对比',
    'filewatch.diff.title': '文本对比:{name}',
    'filewatch.diff.col.external': '外部(磁盘)',
    'filewatch.diff.col.local': '本地(可编辑)',
    'filewatch.diff.hint': '右侧可直接编辑。点击 ←/→ 单段复制,n/p 跳到下一处/上一处,Ctrl+Enter 应用。',
    'filewatch.diff.btn.prev': '上一处',
    'filewatch.diff.btn.next': '下一处',
    'filewatch.diff.btn.apply': '应用结果',
    'filewatch.diff.btn.cancel': '取消',
    'filewatch.diff.btn.copyToRight': '从外部复制到本地',
    'filewatch.diff.btn.copyToLeft': '从本地复制到外部',
    'filewatch.diff.btn.applyAll': '全部应用到右侧',
    'filewatch.diff.btn.locate': '定位到该差异',
    'filewatch.diff.ignoreWhitespace': '忽略空白字符(空格 / 制表符)',
    'filewatch.diff.empty': '没有差异',
    'filewatch.diff.largeFile': '文件较大,行级 diff 已降级为单 hunk 整体替换',
    'filewatch.merged': '已应用合并结果',
    'filewatch.prefs.title': '文件监听设置',
    'filewatch.prefs.message': '配置外部文件修改后的提示、重载与调试行为。',
    'filewatch.prefs.enabled': '启用外部修改监听',
    'filewatch.prefs.enabled.hint': '关闭后,外部修改不会触发任何提示或自动重载',
    'filewatch.prefs.autoReloadClean': '干净标签自动重载',
    'filewatch.prefs.autoReloadClean.hint': '当前标签未修改时,自动用磁盘内容覆盖;脏标签仍会弹模态',
    'filewatch.prefs.debugLog': '调试日志',
    ...
    'lib.settings.metadataLabels': '元数据字段显示名',
    'lib.settings.metadataLabels.defaults': '填入默认',
    'lib.settings.metadataLabels.hint': '每行一个映射：key = 显示名；空行和 # 注释会忽略。未配置的 key 使用内置默认显示名，仍未命中则显示原 key。',
    ...
    'lib.settings.exportConfig': '导出此库配置…',
    'lib.settings.exportConfig.title': '导出库配置',
    'lib.settings.exportConfig.desc': '将当前库的 .flymd/config.json（共享段）打包为 .flymdconfig 文件。可选是否包含凭据。',
    'lib.settings.exportConfig.noCredentials': '不含凭据（仅 config.json）',
    'lib.settings.exportConfig.withCredentials': '包含凭据（+ local.json）',
    'lib.settings.exportConfig.confirmCreds': '将包含图床/S3 凭据与加密密钥等敏感数据。请妥善保管，不要分享给他人。',
    'lib.settings.exportConfig.success': '已导出至 {path}',
    'lib.settings.exportConfig.cancelled': '已取消',
    ...
    'ctx.revealInExplorer': '在资源管理器中打开',
    'ctx.moveTo': '移动到…',
    'ctx.pastePlain': '纯文本粘贴',
    'ctx.copySelection': '复制选中内容',
    ...
    'ctx.exportPdf': '导出为 PDF',
    'ctx.convertOffice': '转为 Markdown',
    'ctx.convertOfficeNeedPlugin': '请先在插件管理中启用「Word/Excel 导入工具」插件',
    'ctx.rename': '重命名',
    'ctx.delete': '删除',
    ...
    'ext.builtin.officePreview.name': 'Word 文档预览',
    'ext.builtin.officePreview.desc': '在库树与打开对话框中支持 .doc/.docx：临时转换为 Markdown 或 PDF 以预览，不影响原文件。',
    'officePreview.dialogName': 'Word 文档',
    'officePreview.converting': '正在转换 Word 文档…',
    'officePreview.converted': '已转换为临时副本进行预览',
    'officePreview.tmpCopyNotice': '正在预览临时副本：这里的修改不会影响原 Word 文件',
    'officePreview.noSoffice': '未检测到 LibreOffice，无法预览 .doc 文件；请用系统程序打开',
    'officePreview.convertFail': 'Word 转换失败：{msg}',
    'officePreview.ruleNotReady': 'Word 预览扩展初始化中，文档将稍后自动打开…',
    'officePreview.needEnable': '无法直接打开 Word 文档：请在扩展面板启用「Word 文档预览」后重试',
    'officePreview.enableOk': 'Word 文档预览已启用',
    'officePreview.disableOk': 'Word 文档预览已停用',
    'officePreview.readonlyNotice': 'Word 预览副本为只读，已保持阅读模式',
  ...
  en: {
    ...
    'theme.codeWrap': 'Code block word wrap',
    'theme.codeWrap.tip': 'When enabled, code blocks wrap automatically in reading/WYSIWYG mode without horizontal scrollbars',
    ...
    'theme.wysiwygHtmlTableSrcEdit': 'HTML source editing',
    'theme.wysiwygHtmlTableSrcEdit.tip': 'When disabled, WYSIWYG hides the HTML source-edit entries (table hover pencil button, double-click on HTML blocks); edits are written back to the document directly',
    ...
    'theme.updateCheckDisabled.tip': 'When enabled, FlyMD will not check for new versions on startup or from the update button',
    'theme.darkMode': 'Dark mode',
    'theme.compactTitlebar': 'Compact title bar',
    'theme.libColorDepth': 'Colored library tree',
    ...
    'menu.filewatchPrefs': 'File Watch Settings…',
    ...
    'filewatch.reloadFailed': 'Reload after external change failed, please reopen manually',
    'filewatch.conflict.title': 'File modified externally',
    'filewatch.conflict.body': '{name} has been modified by another program, and the current document has unsaved changes. Choose how to proceed:',
    'filewatch.conflict.btn.reload': 'Reload (discard local)',
    'filewatch.conflict.btn.keep': 'Keep local (will overwrite on save)',
    'filewatch.conflict.btn.cancel': 'Cancel',
    'filewatch.conflict.btn.diff': 'Compare & Merge',
    'filewatch.diff.title': 'Compare: {name}',
    'filewatch.diff.col.external': 'External (disk)',
    'filewatch.diff.col.local': 'Local (editable)',
    'filewatch.diff.hint': 'Edit the right side directly. Click ←/→ to copy a hunk, n/p for next/prev, Ctrl+Enter to apply.',
    'filewatch.diff.btn.prev': 'Prev',
    'filewatch.diff.btn.next': 'Next',
    'filewatch.diff.btn.apply': 'Apply',
    'filewatch.diff.btn.cancel': 'Cancel',
    'filewatch.diff.btn.copyToRight': 'Copy external → local',
    'filewatch.diff.btn.copyToLeft': 'Copy local → external',
    'filewatch.diff.btn.applyAll': 'Apply all to right',
    'filewatch.diff.btn.locate': 'Locate this hunk',
    'filewatch.diff.ignoreWhitespace': 'Ignore whitespace (spaces / tabs)',
    'filewatch.diff.empty': 'No differences',
    'filewatch.diff.largeFile': 'File is large; per-line diff is degraded to a single hunk replacement.',
    'filewatch.merged': 'Merged result applied',
    'filewatch.prefs.title': 'File Watch Settings',
    'filewatch.prefs.message': 'Configure prompts, reload, and debug behavior for external file changes.',
    'filewatch.prefs.enabled': 'Watch external file changes',
    'filewatch.prefs.enabled.hint': 'When off, external edits produce no prompts or auto-reloads.',
    'filewatch.prefs.autoReloadClean': 'Auto-reload clean tabs',
    'filewatch.prefs.autoReloadClean.hint': 'Auto-apply disk content when the current tab is clean; dirty tabs still prompt.',
    'filewatch.prefs.debugLog': 'Debug logging',
    ...
    'lib.settings.metadataLabels': 'Metadata Field Labels',
    'lib.settings.metadataLabels.defaults': 'Fill defaults',
    'lib.settings.metadataLabels.hint': 'One mapping per line: key = label. Empty lines and # comments are ignored. Unconfigured keys use built-in labels, then fall back to the original key.',
    ...
    'lib.settings.exportConfig': 'Export this library config…',
    'lib.settings.exportConfig.title': 'Export library config',
    'lib.settings.exportConfig.desc': 'Package the current library\'s .flymd/config.json (shared section) as a .flymdconfig file. Optionally include credentials.',
    'lib.settings.exportConfig.noCredentials': 'Without credentials (config.json only)',
    'lib.settings.exportConfig.withCredentials': 'With credentials (+ local.json)',
    'lib.settings.exportConfig.confirmCreds': 'Will include image-hosting/S3 credentials and encryption keys. Keep it safe, do not share.',
    'lib.settings.exportConfig.success': 'Exported to {path}',
    'lib.settings.exportConfig.cancelled': 'Cancelled',
    'lib.refresh': 'Refresh',
    ...
    'ctx.exportPdf': 'Export to PDF',
    'ctx.convertOffice': 'Convert to Markdown',
    'ctx.convertOfficeNeedPlugin': 'Please enable the "Word/Excel Importer" plugin in Plugin Manager first',
    'ctx.rename': 'Rename',
    'ctx.delete': 'Delete',
    ...
    'ext.builtin.officePreview.name': 'Word Document Preview',
    'ext.builtin.officePreview.desc': 'Supports .doc/.docx in the library tree and open dialog: converts to a temporary Markdown or PDF for preview without touching the original file.',
    'officePreview.dialogName': 'Word Documents',
    'officePreview.converting': 'Converting Word document…',
    'officePreview.converted': 'Converted to a temporary copy for preview',
    'officePreview.tmpCopyNotice': 'Previewing a temporary copy: edits here do not affect the original Word file',
    'officePreview.noSoffice': 'LibreOffice not detected; cannot preview .doc files. Please open with a system application',
    'officePreview.convertFail': 'Word conversion failed: {msg}',
    'officePreview.ruleNotReady': 'Word preview is initializing; the document will open shortly…',
    'officePreview.needEnable': 'Cannot open Word documents directly: enable "Word Document Preview" in the Extensions panel and retry',
    'officePreview.enableOk': 'Word document preview enabled',
    'officePreview.disableOk': 'Word document preview disabled',
    'officePreview.readonlyNotice': 'Word preview copy is read-only; staying in reading mode',
